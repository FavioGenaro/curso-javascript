...
if (usuario && puedePagar) { // por defecto lo compara con un true (usuario == true && puedePagar==true)
    console.log('Tu Pedido se hizo con éxito...');
    
} else { // en caso de que alguno o ambos no sean true, se irá al else
...
//En este caso el orden de los else if es muy importante, porque el análisis se realiza de arriba hacia abajo, por lo debes tener en cuenta cual de las condiciones se debe ejecutar primero.
