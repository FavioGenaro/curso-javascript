...
// Con un foreach podemos saber el total a pagar
...
// total(mantiene el valor previo, que acumula), actual(valor del item actual)
// el cero es el valor incial,es para el acumulador, total = 0
