...
// Recorrer por un Foreach, es el ideal para recorrer un arreglo
// foreach es un arroundfuntion. .forEach(valor, indice del valor)

// pendiente e index son variables que usamos dentro del foreach
...
carrito.forEach( producto => console.log(producto.producto));
