...
let numero2 = null;
console.log(numero2);
console.log(typeof numero2); // (de tipo obejeto)ahora esto nos dirá que es un objeto, la especificación de ecma, que es quien define el standard del lenguaje, dice que null debe ser un objeto
