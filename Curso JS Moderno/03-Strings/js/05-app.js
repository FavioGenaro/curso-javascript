...
console.log(producto.slice(0, 10)); // Iniciar en 0 y cortar hasta la posición 10
...
console.log(producto.substring(2, 8));  // Si el número es mayor al segundo, va a cortar hacia atras (voltear los números)
